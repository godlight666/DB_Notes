...
* [ ] 幻像读的解决办法：index lock和间隙锁还要具体了解一下。
* [ ] mapreduce复习一下
* [X] GFS复习一下
* [X] bigtable要了解下
* [ ] 负载均衡，redis，zookeeper要了解下
* [ ] 火山模型，算子等得了解一下
* [ ] mysql中的各种索引，辅助索引是什么，回表是什么。
* [ ] B+树的锁
* [ ] 慢查询
...
前者适合读多写少的场景，后者适合大部分场景。因为修改少时，乐观锁不用锁住数据，没有资源的浪费。但是当修改多的时候，乐观锁会反复的重试然后失败，导致浪费资源。
